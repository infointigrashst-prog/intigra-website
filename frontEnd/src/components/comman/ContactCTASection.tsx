...
export default function ContactCTASection() {
  return (
    <section
      id="contact"
      className="py-10 md:py-10 relative overflow-hidden border-t border-white/5"
    ...
    >
      ...
      {/* Corner accents */}
      <div className="absolute top-0 left-0 w-24 h-24 border-t-2 border-l-2 border-orange-500/10" />
      <div className="absolute bottom-0 right-0 w-24 h-24 border-b-2 border-r-2 border-orange-500/10" />
